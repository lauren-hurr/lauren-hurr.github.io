...
const trigElements = ['#section-01-trigger', '#section-02-trigger','#section-03-trigger', '#section-04-trigger'];
const targIDs = ['#sticky-header-01', '#sticky-header-02','#sticky-header-03', '#sticky-header-04'];
